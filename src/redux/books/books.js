...
export const addBookApi = (payload) => async (dispatch) => {
  ...
  await Axios.post('https://us-central1-bookstore-api-e63c8.cloudfunctions.net/bookstoreApi/apps/3S63EgRauta5QFkOHbpD/books', newBook);
...
export const removeBookApi = (id) => async (dispatch) => {
  await Axios.delete(`https://us-central1-bookstore-api-e63c8.cloudfunctions.net/bookstoreApi/apps/3S63EgRauta5QFkOHbpD/books/${id}`);
